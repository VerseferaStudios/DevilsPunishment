...
public class RoomNewVents2ndFloor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        */
        ...
        // ------------------- Find exactly overlapping doors/spawnPoints, dont spawn a corridor at thst position, and do destroy both doors/spawnPoints -------------------
        /*
        ...
        for (k = 0; k < spawnPoints.Count; k++)//or k+=2 does it matter?
        {
            ...
            */
            ...
            if (k == spawnPoints.Count - 1)
            {
                ...
                StartCoroutine(Data2ndFloor.instance.DoCheckVentsPerSecond()); // EDIT FOR VENTS!!!
            }
    ...
    public void ConnectTwoRooms(Transform spawnPointk, Transform spawnPointl)
    {
        ...
        kPos.y = lPos.y = 0.5f - 2f + Data2ndFloor.instance.floor2Height;
        ...
        if(From.x == lPos.x)
        {
            targetPos = new Vector3(From.x, 0.5f - 2f + Data2ndFloor.instance.floor2Height, lPos.z);
        }
        else
        {
            targetPos = new Vector3(lPos.x, 0.5f - 2f + Data2ndFloor.instance.floor2Height, From.z);
        }
